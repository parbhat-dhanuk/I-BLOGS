...
<div
  id="page-container"
  className="mx-auto flex min-h-dvh w-full min-w-[320px] flex-col bg-green-300 dark:bg-gray-900 dark:text-gray-100"
>
  
  <main id="page-content" className="flex max-w-full flex-auto flex-col">
    <div
      className="relative mx-auto flex min-h-dvh w-full max-w-10xl items-center justify-center overflow-hidden p-4 lg:p-8"
    >
      ...
      <section className="w-full max-w-xl py-6">
        ...
        <header className="mb-10 text-center">
          <h1 className="mb-2 inline-flex items-center gap-2 text-2xl font-bold">
            ...
            <span> {type==="Register"?" Register Here For Contribution...":"Login Here..."} </span>
          </h1>
          <h2 className="text-sm font-medium text-gray-500 dark:text-gray-400">
           {type==="Register"?" Welcome, please sign in to your dashboard":" Welcome, please Log in to your dashboard"}
          </h2>
        </header>
   ...
   <div className="space-y-1">
...

             {
              ...
              <div>
                ...
                <button type="submit" className="inline-flex w-full items-center justify-center gap-2 rounded-lg border border-blue-700 bg-blue-700 px-6 py-3 font-semibold leading-6 text-white hover:border-blue-600 hover:bg-blue-600 hover:text-white focus:ring focus:ring-blue-400/50 active:border-blue-700 active:bg-blue-700 dark:focus:ring-blue-400/90" >
                  <span>{type}</span>
                </button>
